		...
		<center>
			...
			<div class="service-list-menu">
				<h2 class="service-list"> 
						<a href="admin_manage_contents_service_add.php" style="color: #847373;"> <u> 
						Add Service In website Template
						</a> 
						</u>
				</h2>
			</div>
			...
			<div class="service-list-menu">
				<h2 class="service-list"> <a href="admin_manage_contents_services_delete.php" style="color: #847373;"> <u> Delete Service In website Template </a> </u></h2>
			</div>
