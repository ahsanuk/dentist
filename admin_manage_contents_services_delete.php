<!-- following page is for manage services displayed on the website template  -->

<?php
	session_start();
	// checcking admin session is  set or not for authentication of an admin
	...
	if( $_SERVER['REQUEST_METHOD'] === "POST" ){
			...
			if( $stmt->rowCount() > 0 ){
				$_SESSION['success'] = 1;
				header("Location: admin_manage_contents_services_delete.php");
				die();
			}
			else{
				$_SESSION['success'] = 0;
			...
			<div style="margin-left: 5%; margin-right: 5%;">
				<form action="" method="post">
					<table>
					  <tr>
					  <th>select</th>
					  	<th>Present Services on Template</th>
					  </tr>
