...
<?php
	...
	if( $_SERVER['REQUEST_METHOD'] === "POST" ){
			...
			$stmt->execute( [ 'consultation_fees' ,$_POST['consultation_fees'], $_POST['amount'] ] );
			// counting the affected rows
			if( $stmt->rowCount() > 0 ){
				$_SESSION['success'] = 1;
				header("Location: admin_manage_contents_consultation_fees_add.php");
				die();
			}
			else{
				$_SESSION['success'] = 0;
		...
		<center>
			...
			<div class="service-list-menu">
				<h2 class="service-list"> 
						<a href="admin_manage_contents_consultation_fees.php" style="color: #847373;"> <u> Manage Consultation 
						</a> 
				</u></h2>
			</div>
			...
			<div style="margin-left: 5%; margin-right: 5%;">
				...
				<div style="margin-left: 20%; margin-right: 20%;">
				  <form action="" method="post">
				    <label for="fname"> Add Consultation</label>
				    <input type="text" id="fname" name="consultation_fees" placeholder="consultation Name..">
				    <input type="number" id="fname" name="amount" placeholder="consultation amount">
				    <input style="background-color: #44c38d;" type="submit" value="Add Consultation Fees">
				  </form>
				</div>
