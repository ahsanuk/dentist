		...
		<center>
			...
			<div class="service-list-menu">
				<h2 class="service-list"> 
						<a href="admin_manage_contents_consultation_fees_add.php" style="color: #847373;"> <u> 
						Add Consultation Fees In website Template
						</a> 
						</u>
				</h2>
			</div>
			...
			<div class="service-list-menu">
				<h2 class="service-list"> <a href="admin_manage_contents_consultation_fees_delete.php" style="color: #847373;"> <u> Delete Consultation Fees In website Template </a> </u></h2>
			</div>
